...
\pair{2024年}{
 ...
 \visual{02-bcore-opening.png}{34mm}{写真：B-Core開所式}
}{2025--2026年}{
 \bigtext{大学院と企業へ広がる}
 \bullets{
 ...
 \vspace{-2.2mm}
 \visual{03-first-cohort.png}{30mm}{写真：大学院1期生}
}
\end{frame}
...
\pair{データサイエンス特論1（M1）}{
 ...
 \visual{04-practice-poster.png}{34mm}{写真：最終ポスター発表会}
}{データサイエンス実践演習}{
 \bigtext{企業課題を研究へ変える}
 \bullets{
...
\pair{高校ではなく大学理事から}{
 ...
 \vspace{-1.8mm}
 \visual{poster-highschool-class.png}{27mm}{写真：高校での授業}
 {\fontsize{6}{7.2}\selectfont\color{Muted}
  なぜ理事から研究室へ指令が来るのかは今も謎。出典：文部科学省「総合的な学習（探究）の時間」\par}
}{こちらから仕掛ける活動}{
 \bigtext{小学生へカードを配る}
 \bullets{
 ...
 \vspace{-.8mm}
 \visual{poster-card-game.png}{37mm}{画面：データサイエンスカードゲーム}
}
\end{frame}
...
\pair{高校生は地元へ戻るという見立て}{
 ...
 \bullets{
  ...
  \lineitem{大分ガスとクラウン建築設計事務所から各1名が、会社所属のまま入学}
  \lineitem{配管故障の推定／建物の耐震補強を研究にする}
  \lineitem{会社の課題を研究へ変え、知見を会社へ戻す}}
 \visual{poster-oita-hub.png}{29mm}{図：大分大学を中心にした地域の知的循環}
}
\bridge{社会人受け入れ ＝ 学生確保 ＋ 産学融合 ＋ 地域企業への知見還元}
\end{frame}

\begin{frame}[t]
\head{共同研究費の一部を、学生が集まる場所へ戻しました}{03}{地域との接点と研究環境}
\pair{DAIBから共同研究へ}{
 \bigtext{「AIの人」として名刺を配る}
 \bullets{
  \lineitem{県庁のAI連携団体DAIBでフェローを務める}
  \lineitem{地域企業、県庁職員、教育委員会と接点をつくる}
  \lineitem{技術相談を授業、研究、共同研究へつなぐ}}
 \vspace{1mm}
 \begin{center}
  \includegraphics[height=8mm]{assets/poster-daib.png}
 \end{center}
}{共同研究の間接経費で}{
 \bigtext{学生ラウンジをつくる}
 {\fontsize{8.1}{10.5}\selectfont
  \lineitem{共同研究費の一部が間接経費として研究環境へ戻る}
  \lineitem{DXイノベーション工房に、学生が集まれる場所を整備}
  \lineitem{佐伯の木材加工会社・マツオカとつくった空間}\par}
 \makebox[\linewidth][c]{\includegraphics[width=.94\linewidth]{assets/student-lounge-matsuoka.jpg}}
}
\bridge{名刺 → 技術相談 → 共同研究 → 間接経費 → 学生の居場所}
\end{frame}

\begin{frame}[plain]
\begin{tikzpicture}[remember picture,overlay]
 \node[inner sep=0] at (current page.center) {%
  \includegraphics[width=\paperwidth]{assets/poster-data-ai-social.png}};
\end{tikzpicture}
\end{frame}
...
\pair{研究課題が決まらない}{
 ...
 \visual{buildabstract-demo-poster.png}{29mm}{画面：Build Abstractの研究計画生成}
}{実装で止まる}{
 \bigtext{学生は書かずに指示する}
 \bullets{
...
\pair{研究一色ではない日常}{
 ...
 \begin{columns}[T,totalwidth=\linewidth]
  \begin{column}{.37\linewidth}
   ...
   \fbox{\includegraphics[page=1,width=\dimexpr\linewidth-1.7mm\relax]{assets/wi26-paper.pdf}}\endgroup
  \end{column}
...
\pair{提案アルゴリズム：$N(D)$}{
 ...
 \vspace{-1.5mm}
 \visual{wi26-algorithm.png}{24mm}{WI26論文の提案手法}
 ...
 \vspace{-1.5mm}
 \visual{wi26-results.png}{30mm}{数値摂動と再識別結果}
...
\pair{平時から同じ場所で作業}{
 ...
 \bigtext{全部が一画面に見える}
 \vspace{-1.5mm}
 \visual{shared-research-workspace.png}{47mm}{VS Code上の共有研究環境}
...
\pair{会話も研究記録にする}{
 ...
 \bigtext{作業の実況を共有する}
 \vspace{-1.5mm}
 \visual{buzz-shared-agent.png}{47mm}{Buzz上の学生・大知・AI Agentの共同作業}
...
\begin{tikzpicture}[remember picture,overlay]
 ...
 \node[anchor=east,rounded corners=1.8mm,fill=Ink,text=white,
  inner xsep=2.3mm,inner ysep=3mm,font=\fontsize{6.5}{8}\selectfont]
  at ([xshift=-2.5mm]current page.east) {%
   \shortstack{この資料も\\[1mm]
    \textcolor{Gold}{\bfseries Beamer × Codex}\\[1mm]
    で作りました}};
\end{tikzpicture}
\end{frame}
